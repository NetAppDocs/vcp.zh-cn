...
[role="lead"]
此外、还为适用于VMware vCenter Server的NetApp Element插件5.4之前的版本提供了相关文档。


NOTE: link:index.html["文档链接"]适用于Element vCenter插件5.4的版本还包括5.3、5.2、5.1、5.0、4.10、4.9、4.8、4.7和4.6。
