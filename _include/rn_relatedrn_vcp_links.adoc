...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP2878089["《 NetApp Element 软件 12.3.1 发行说明》"^] _new_
...
* https://docs.netapp.com/us-en/hci/docs/rn_compute_firmware_2.76.10.html["计算固件包 2.76.10 发行说明（最新）"^]
