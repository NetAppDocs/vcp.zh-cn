...
* https://docs.netapp.com/us-en/hci/docs/rn_compute_firmware_2.76.html["计算固件包 2.76 发行说明（最新）"^]
...
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.76.html["存储固件包 2.76 发行说明（最新）"^]
