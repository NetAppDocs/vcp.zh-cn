...
[role="lead"]
您可以按照安装中描述的步骤升级适用于 vCenter Server 的NetApp Element插件。  NetApp Element vCenter 插件 5.5 在 Element 和NetApp HCI版本之外作为管理服务包的一部分提供。
...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3344864["NetApp Element vCenter 插件 5.5 发行说明"^]
...
* https://docs.netapp.com/us-en/element-software/index.html["SolidFire 和Element文档资源"^]
